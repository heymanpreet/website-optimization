...
var resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) {
		...
		var ContainerLength = randomPizzaContainer.length;
...
function updatePositions() {
    ...
    //moved the scrolltop outside,it will make the browser to query less
    var calc = document.documentElement.scrollTop/1250; //|| document.documentElement.scrollTop/1250;
